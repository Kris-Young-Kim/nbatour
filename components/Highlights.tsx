...
const HIGHLIGHTS = [
  {
    id: 1,
    title: '농구 성지 순례',
    description: 'NBA 유튜버 김맘바와 함께하는 특별한 농구 성지 투어',
    icon: (
  ...
  },
  {
    id: 2,
    title: '3경기 NBA 직관',
    description: 'Warriors, Lakers 등 빅매치 3경기를 직접 관람',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 3,
    title: '전식사 프로그램',
    description: '호텔 조식, 경기장 식사비 지급 등 완벽한 식사 제공',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 4,
    title: '₩1억 여행자보험 + 호텔',
    description: '안전한 여행을 위한 보험과 4성급 호텔 숙박',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
